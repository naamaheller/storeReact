...
const EditProduct = () => {
    const { id } = useParams();
    console.log("EditProduct - id from useParams:", id); // בדיקה שה-id מתקבל
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            ...
            try {
                ...
                console.log("Product data:", response.data); // בדיקה
    ...
    const onSubmit = async (data) => {
        ...
        console.log("Updating product:", updatedData); // בדיקה
